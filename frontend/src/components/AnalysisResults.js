  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="card">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            {/* Age Estimation */}
            <div className="bg-gradient-to-r from-primary-50 to-equine-50 p-4 rounded-lg border border-primary-200">
              <div className="flex items-center mb-2">
                <Calendar className="w-5 h-5 text-primary-600 mr-2" />
                <h3 className="text-lg font-semibold text-gray-900">Estimated Age</h3>
              </div>
              <div className="flex items-baseline space-x-2">
                <span className="text-3xl font-bold text-primary-700">{result.estimatedAge}</span>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <button
          onClick={onGenerateReport}
          className="btn-equine px-8 py-3 text-lg font-semibold flex items-center justify-center"
        >
